...
<div id="title_bar">
	...
	<div id="new_button">
		<a href="javascript:window.print()"><div class='btn btn-info' style='float: left;'><span><?php echo $this->lang->line('common_print'); ?></span></div></a>
	</div>
</div>
...
<div id="table_action_header">
	<ul>
		<li class="btn btn-danger"><?php echo anchor($controller_name . "/delete",$this->lang->line("common_delete"),array('id'=>'delete')); ?></li>
