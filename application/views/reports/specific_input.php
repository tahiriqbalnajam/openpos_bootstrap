...
?>
	...
	<div id='report_specific_input_data'>
		<?php echo form_dropdown('specific_input_data',$specific_input_data, '', 'id="specific_input_data" class="form-controll"'); ?>
	</div>
	...
	<div id='report_sale_type'>
		<?php echo form_dropdown('sale_type',array('all' => $this->lang->line('reports_all'), 
		  ...
		  'returns' => $this->lang->line('reports_returns')) , 'all', 'id="sale_type" class="form-controll"'); ?>
	</div>
