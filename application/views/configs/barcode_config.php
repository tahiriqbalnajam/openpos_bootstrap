...
?>
    <div id="config_wrapper">
        <fieldset id="config_info">
            ...
            <div class="field_row clearfix">    
            <?php echo form_label('Total Number of Rows:', 'barcode_num_in_row',array('class'=>'wide required')); ?>
                <div class='form_field'>
                <?php echo form_input(array(
                    'name'=>'barcode_total_rows',
                    'id'=>'barcode_total_rows',
					'class'=>'form-control',
                    'value'=>$this->config->item('barcode_total_rows')));?>
                </div>
            </div>
